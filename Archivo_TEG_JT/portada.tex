...
\put(-1,-16){{
\begin{minipage}[h]{8cm}
Caracas, Noviembre de 2023 (Ej. mayo de 2009)
\end{minipage}}
}%
...
\begin{spacing}{1}
    Presentado ante la ilustre\\
Universidad Central de Venezuela\\
por el Br. Jose Alejandro Tovar Briceño para optar\\
...
\vspace{2.1cm}%
\begin{large}
\textbf{DISEÑO DE UN SENSOR INTELIGENTE PARA APLICACIONES \\
DE MONITOREO DE SALUD ESTRUCTURAL  \\
tercera línea del título del Trabajo de Grado \\
}
\end{large}
\end{center}
\end{titlepage}

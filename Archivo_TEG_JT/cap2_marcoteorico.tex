...
La instrumentación estructural ayuda a validar los modelos y suposiciones utilizados en el diseño estructural inicial. Al comparar los datos recopilados por la instrumentación durante un evento sísmico con las predicciones del modelo, es posible verificar si la estructura se comporta de acuerdo con las expectativas y si cumple con los criterios de seguridad establecidos en la norma.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{figure}[H]
                ...
                \label{fig:hig-res}
            \end{figure}
            \item Micro-electromecánicos (MEMS): suelen utilizar una capa de material sensible a la humedad, como un polímero higroscópico, que experimenta cambios en sus propiedades físicas, eléctricas o capacitivas en respuesta a la humedad del ambiente. 
            \begin{figure}[H]
                \centering
        ...
        \begin{itemize}
            ...
            \begin{figure}[H]
                ...
                \begin{minipage}{0.45\textwidth}
                    ...
                    \caption{Acelerómetro micro-electromecánico \citep{dunn2005introduction}.}
                    \label{fig:acc-mems2}
                \end{minipage}
            \end{figure}


            \item Balance de fuerzas: Este tipo de acelerómetro consiste en un detector de posición, un amplificador y un sistema electromecánico de posicionamiento. El sistema convierte una fuerza mecánica en una corriente proporcional que se convierte en una fuerza en dirección contraria para contrarrestar el movimiento de la masa suspendida. 
